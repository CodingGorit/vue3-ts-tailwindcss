  ...
  <div class="max-w-[85rem] px-4 py-4 sm:px-6 lg:px-8 mx-auto">
    ...
    <div class="grid justify-center md:grid-cols-2 md:justify-between md:items-center gap-2">
      ...
      <div class="flex items-center">
        <a class="py-2 px-3 inline-flex justify-center items-center gap-2 rounded-md font-medium text-white hover:bg-white/[.1] focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 transition-all text-sm" href="https://github.com/CodingGorit/vue3-ts-tailwindcss" target="_blank">
